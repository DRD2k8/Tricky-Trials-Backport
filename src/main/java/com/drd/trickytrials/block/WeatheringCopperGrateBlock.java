...
public class WeatheringCopperGrateBlock extends WaterloggedTransparentBlock implements CustomWeatheringCopper {
    private final WeatherState weatherState;

    public WeatheringCopperGrateBlock(WeatherState p_154925_, BlockBehaviour.Properties p_154926_) {
        super(p_154926_);
