...
public class WeatheringCopperBulbBlock extends CopperBulbBlock implements CustomWeatheringCopper {
    private final CustomWeatheringCopper.WeatherState weatherState;

    public WeatheringCopperBulbBlock(CustomWeatheringCopper.WeatherState p_154925_, BlockBehaviour.Properties p_154926_) {
        super(p_154926_);
